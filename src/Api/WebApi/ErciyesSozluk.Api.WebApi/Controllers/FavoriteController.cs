using ErciyesSozluk.Api.Application.Features.Commands.Entry.CreateFav;
using ErciyesSozluk.Api.Application.Features.Commands.Entry.DeleteFav;
using ErciyesSozluk.Api.Application.Features.Commands.EntryComment.CreateFav;
using ErciyesSozluk.Api.Application.Features.Commands.EntryComment.DeleteFav;
using MediatR;
